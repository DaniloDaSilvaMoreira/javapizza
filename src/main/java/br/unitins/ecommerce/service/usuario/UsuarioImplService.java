...
public class UsuarioImplService implements UsuarioService {
    ...
    public void insertListaDesejo(ListaDesejoDTO listaDto) throws NullPointerException {
        ...
        usuario.setProdutos(pizzaRepository.findById(listaDto.idProduto()));
    }
    ...
    @Override
    public void deleteProdutoFromListaDesejo(Long idUsuario, Long idProduto) {
        ...
        usuario.getProdutos().remove(pizzaRepository.findById(idProduto));
    }
